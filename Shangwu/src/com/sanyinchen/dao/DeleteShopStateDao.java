...
public class DeleteShopStateDao {
	private JdbcUtils jdbcUtils = null;

	public DeleteShopStateDao() {
...
//			System.out.println(list.get(0).toString());
			String sql = "delete from product_shop where product_name_buy=? and product_name=? and flag=? and product_other=?";
