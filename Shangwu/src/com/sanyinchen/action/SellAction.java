...
public class SellAction extends HttpServlet {
	GetProductShopDao mDao;
		...
		if (list != null) {
			for (int i = 0; i < list.size(); i++) {
				...
				str += map.get("product_dingdan").toString() + ","
						...
						+ map.get("product_name_buy").toString() + ","
						...
						+ SellState.getsellsate(value) + ","
						+ SellState.getsellsate2(value);
				if (i != list.size() - 1)
					str += ",";
			}
